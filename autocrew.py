...
import argparse  # Remove the second occurrence of this import statement
...
def main():
    ...
    initialize_logging(verbose=args.verbose, message=startup_message)
